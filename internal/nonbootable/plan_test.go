...
func TestBuildPlanRejectsUnsafeOrUnsupportedInput(t *testing.T) {
	tests := []struct {
		...
		{name: "filesystem", mutate: func(value *Request) { value.Filesystem = "btrfs" }, want: "FAT32, exFAT, NTFS, ext2, ext3, or ext4"},
