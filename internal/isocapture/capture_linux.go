...
func CaptureFilesystem(ctx context.Context, sourceMount, outputPath string, options FilesystemCaptureOptions) (report FilesystemCaptureReport, returnErr error) {
	...
	if validationReport.Status != CapturePassed || validationReport.MountedContentSHA256 != validationReport.ExpectedContentSHA256 || validationReport.ImageSHA256 != masterReport.OutputSHA256 {
