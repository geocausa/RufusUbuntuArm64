...
- Qualified raw imaging, Windows media, FreeDOS, and data-only partition/filesystem interruption at every admitted pre- and post-mutation boundary, including real loop-device cancellation after partition publication, closing the final software interruption residual.
