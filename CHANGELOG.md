...
- Added package-owned bounded helper-process utilities and migrated FFU capture plus persistence analysis and creation to tested process-group escalation, output limits, pipe closure, and reaping.
