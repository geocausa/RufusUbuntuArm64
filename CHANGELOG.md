...
- Migrated the remaining GTK acquisition, checksum, writer, formatter, qualification, backup, ISO, FreeDOS, and FFU workers to shared bounded one-shot or concurrent two-pipe process contracts, closing the helper-process interruption residual.
