...
- Experimental Windows To Go software path completed for Windows 11 client ARM64 GPT/UEFI/NTFS, including live direct-NTFS WIM progress and exact-target kernel I/O-failure cancellation; physical firmware boot and first-boot qualification remain pending
