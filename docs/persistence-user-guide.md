...
6. Keep the USB connected until RufusArm64 reports completion or confirms cancellation cleanup. Copying, filesystem checks, and final buffer flushing can take several minutes on slower flash drives.
