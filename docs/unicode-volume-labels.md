...
- Unit and real-loop tests bind requested, planned, formatted, reopened, and reported labels, including mixed case, non-ASCII text, surrogate pairs, and valid NTFS punctuation.
